...
contract BuildingStorage {
    ...
    function 0x08f822a5(uint256 varg0) public { 
        require(_getName[varg0]);
        return mapping_7[varg0];
    }

    function 0x21d26a38(uint256 varg0) public { 
    ...
    function 0x2c5e9b09(uint256 varg0, uint256 varg1) public { 
        require(msg.sender == owner);
        require(_getName[varg0]);
        mapping_6[varg0] = varg1;
    }

    function 0x394c1f42(uint256 varg0, uint256 varg1) public { 
        require(msg.sender == owner);
        require(_getName[varg0]);
        mapping_5[varg0] = varg1;
    }

    function 0x4610af12(uint256 varg0, uint256 varg1) public { 
        require(msg.sender == owner);
        require(_getName[varg0]);
        mapping_4[varg0] = varg1;
    }

    function 0x50fdbd81(uint256 varg0) public { 
        require(_getName[varg0]);
    ...
    function setStone(bytes32 _buildingHash, uint256 _amount) public { 
        require(msg.sender == owner);
        require(_getName[_buildingHash]);
        stone[_buildingHash] = _amount;
    }

    function setGold(bytes32 _buildingHash, uint256 _amount) public { 
        require(msg.sender == owner);
        require(_getName[_buildingHash]);
        gold[_buildingHash] = _amount;
    }

    function 0x8d4fd8c1(uint256 varg0, uint256 varg1) public { 
        require(msg.sender == owner);
        require(_getName[varg0]);
        mapping_7[varg0] = varg1;
    }

    function setWood(bytes32 _buildingHash, uint256 _amount) public { 
        require(msg.sender == owner);
        require(_getName[_buildingHash]);
        wood[_buildingHash] = _amount;
    }

    function 0xdce9f070(uint256 varg0) public { 
        require(_getName[varg0]);
        return mapping_4[varg0];
    }

    function getWood(bytes32 _buildingHash) public { 
        require(_getName[_buildingHash]);
    ...
    function getStone(bytes32 _buildingHash) public { 
        require(_getName[_buildingHash]);
        return stone[_buildingHash];
    }

    function getGold(bytes32 _buildingHash) public { 
        require(_getName[_buildingHash]);
    ...
    function 0xfe6f1143(uint256 varg0) public { 
        require(_getName[varg0]);
