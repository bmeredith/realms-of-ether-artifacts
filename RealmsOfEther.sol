...
contract RealmsOfEther is Pausable {
    ...
    mapping (uint256 => bytes32) mapping_8; // STORAGE[0x8] mapping_8
    mapping (uint256 => address) mapping_9; // STORAGE[0x9] mapping_9
    mapping (uint256 => bytes32) mapping_a; // STORAGE[0xa] mapping_a
    mapping (uint256 => address) _highestBidder; // STORAGE[0xb]
    mapping (address => uint256[]) _userAuctions; // STORAGE[0xc]
    mapping (uint256 => bytes32) mapping_d; // STORAGE[0xd] mapping_d
    mapping (address => address) _balances; // STORAGE[0xe]
    ...
    function getFortressCount() public view returns (uint256) { 
        MEM[32 + MEM[64]] = 0;
        require(bool(0xe5ef9a283508bbfd11d5379efc4146a4e4a26b8a.code.size));
        v0, /* uint256 */ v1 = 0xe5ef9a283508bbfd11d5379efc4146a4e4a26b8a.delegatecall(uint32(0x3f0a6f3d), fortressStorage).gas(msg.gas - 710);
        require(bool(v0));
        return v1;
    }
    ...
    function getTroupHash(bytes32 varg0) public view { 
        MEM[32 + MEM[64]] = 0;
        require(bool(0x902904b1833def4aef05b99cea93cc3383cd2d4a.code.size));
        v0, /* uint256 */ v1 = 0x902904b1833def4aef05b99cea93cc3383cd2d4a.getHash(troupStorage, varg0).gas(msg.gas - 710);
        require(bool(v0));
        return v1;
    }
