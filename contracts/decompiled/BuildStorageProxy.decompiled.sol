...
function 0xf481d125(address varg0, uint256 varg1, bytes16 varg2, uint256 varg3, uint256 varg4, uint256 varg5, uint256 varg6, uint256 varg7, uint256 varg8, uint256 varg9) public payable { 
...
function 0x9d3bd2e4(address varg0, uint256 varg1) public payable { 
    MEM[32 + MEM[64]] = 0;
    require(bool(varg0.code.size));
...
function __function_selector__( function_selector) public payable { 
    ...
    if (msg.data.length >= 4) {
        if (0x99a88ec4 == uint32(function_selector >> 224)) {
            upgrade(address,address);
        } else if (0x9d3bd2e4 == uint32(function_selector >> 224)) {
            0x9d3bd2e4();
        } else if (0xed05582b == uint32(function_selector >> 224)) {
            getHash(address,uint256);
        } else if (0xf481d125 == uint32(function_selector >> 224)) {
            0xf481d125();
